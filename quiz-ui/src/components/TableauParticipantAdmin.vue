<template>
  <div class="container">
      <div class="row">
        <div class="col">
          <h1 class="titre text-center my-3">Liste des participants</h1>
          <table>
            <tr>
              <th><b>Rang</b></th>
              <th><b>Nom</b></th>
          ...
          <div class="text-center py-5">
            <button @click="deleteParticipationsAll()" class="btn btn-outline-danger">Supprimer les participants</button>
          </div>
        </div>
      </div>
    </div>
